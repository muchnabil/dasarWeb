<?php
include 'auth.php'; // Mengaktifkan sesi dan membuat $_SESSION['csrf_token']
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    integrity="sha384-fnmOCqbT1Wj8LYJmZkNCppQOpQbyI7RrhN7Uj9KWwkMkMpHvLBhG9sN" crossorigin="anonymous">
...
<script type="text/javascript">
    ...
    // Melakukan validasi final sebelum mengirim data via AJAX
    if (nama != "" && alamat != "" && (document.getElementById("jenkel1").checked == true || document.getElementById("jenkel2").checked == true) && no_telp != "") {
        $.ajax({
            ...
            success: function(data) {
                $('.data').load('data.php');
                document.getElementById("id").value = ""; // Mengosongkan hidden field ID
                document.getElementById("form-data").reset(); // Reset seluruh formulir
            },
